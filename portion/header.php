    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="ind.php"
                                    class="<?php echo $_SERVER['REQUEST_URI'] === '/lshipromo/ind.php'? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white"; ?> rounded-md px-3 py-2 text-sm font-medium">Accuiel</a>
        ...
        <header
            ...
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white"><?php echo $header ?>
            </h1>
            </div>
        </header>
        <main>
